...
<div class="box" style="margin:40px">
    ...
    <div style="padding:20px; font-family:'Saira'; font-weight:bold">
        <form id="admin_hostel" action="database/admin_hostel2.php" method="POST" style="color:#333333" >
            <h3 style="display:inline; text-align:center; color:red">Fill up details to setup Admin Panel</h3> 
            
                    <p style="color:#31708f;">Enter Details For College</p>
                    <div style="margin-top:-10px;">
                                ...
                                <script src="/wp-includes/js/addInput.js" language="Javascript" type="text/javascript"></script>
                                    <div id="dynamicInput">
                                        Hostel 1<br><input type="text" name="myInputs[]">
                                    </div>
                                ...
                                <script>
                                    ...
                                    if (counter == limit)  {alert("You have reached the limit of adding " + counter + " inputs");
                                        ...
                                        newdiv.innerHTML = "Hostel " + (counter + 1) + " <br><input type='text' name='myInputs[]'>";
